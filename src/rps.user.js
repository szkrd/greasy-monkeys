...
(function () {
  ...
  $(() => {
    let blacklist = (word, selector) => $(`.post-inner h1:containsi("${word}")`)
      .closest('article').addClass('js-hide');
    ...
    $('.byline:containsi("John Walker")').closest('article')
      .addClass('js-hide'); // oh god, do I hate this guy
  });
})();
